...
export type SubtensorModuleCall = SubtensorModuleCall_set_weights | SubtensorModuleCall_add_stake | SubtensorModuleCall_remove_stake | SubtensorModuleCall_serve_axon | SubtensorModuleCall_register
