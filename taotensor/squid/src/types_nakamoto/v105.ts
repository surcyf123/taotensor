...
export type Type_69 = Type_69_System | Type_69_Timestamp | Type_69_Grandpa | Type_69_Balances | Type_69_Sudo | Type_69_SubtensorModule

export interface Type_69_System {
    __kind: 'System'
    value: SystemCall
}

export interface Type_69_Timestamp {
    __kind: 'Timestamp'
    value: TimestampCall
}

export interface Type_69_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaCall
}

export interface Type_69_Balances {
    __kind: 'Balances'
    value: BalancesCall
}

export interface Type_69_Sudo {
    __kind: 'Sudo'
    value: SudoCall
}

export interface Type_69_SubtensorModule {
...
export type SubtensorModuleCall = SubtensorModuleCall_set_weights | SubtensorModuleCall_add_stake | SubtensorModuleCall_remove_stake | SubtensorModuleCall_serve_axon | SubtensorModuleCall_register | SubtensorModuleCall_sudo_set_blocks_per_step | SubtensorModuleCall_sudo_set_difficulty | SubtensorModuleCall_sudo_set_adjustment_interval | SubtensorModuleCall_sudo_set_activity_cutoff | SubtensorModuleCall_sudo_target_registrations_per_interval
