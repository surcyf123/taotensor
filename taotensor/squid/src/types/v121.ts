...
export interface SubtensorModuleCall_sudo_set_tempo {
    __kind: 'sudo_set_tempo'
    netuid: number
    tempo: number
}
...
export interface SubtensorModuleCall_sudo_set_registration_allowed {
    __kind: 'sudo_set_registration_allowed'
    netuid: number
...
export interface SubtensorModuleEvent_RegistrationAllowed {
    __kind: 'RegistrationAllowed'
    value: [number, boolean]
}

export interface SubtensorModuleEvent_TempoSet {
    __kind: 'TempoSet'
    value: [number, number]
}
